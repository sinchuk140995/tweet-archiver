"""
Django settings for tweet_archiver project.
...
ROOT_URLCONF = 'tweet_archiver.urls'
...
WSGI_APPLICATION = 'tweet_archiver.wsgi.application'
...
MONGO_DATABASE_NAME = config('MONGO_DATABASE_NAME', default='')
